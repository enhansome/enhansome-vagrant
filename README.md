...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,671 | 🐛 334 | 🌐 Shell | 📅 2026-09-11 - auto-complete for commands, task names, box names and built-in documentation.

...
* [Baseboxes from Opscode](https://github.com/chef/bento#current-baseboxes) ⭐ 4,443 | 🐛 20 | 🌐 HCL | 📅 2026-08-08 - CentOS, Fedora, Debian, FreeBSD, Ubuntu.
...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,276 | 🐛 596 | 🌐 Shell | 📅 2026-08-20 - auto-complete for commands, task names, box names and built-in documentation.

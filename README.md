...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,347 | 🐛 574 | 🌐 Shell | 📅 2026-08-24 - auto-complete for commands, task names, box names and built-in documentation.

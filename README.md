...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,705 | 🐛 337 | 🌐 Shell | 📅 2026-09-13 - auto-complete for commands, task names, box names and built-in documentation.

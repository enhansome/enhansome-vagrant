...
* [Baseboxes from Opscode](https://github.com/chef/bento#current-baseboxes) ⭐ 4,443 | 🐛 22 | 🌐 HCL | 📅 2026-08-08 - CentOS, Fedora, Debian, FreeBSD, Ubuntu.
...
* [List of available Vagrant plugins from GitHub wiki](https://github.com/hashicorp/vagrant/wiki/Available-Vagrant-Plugins) ⭐ 27,200 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03.
...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,356 | 🐛 581 | 🌐 Shell | 📅 2026-08-24 - auto-complete for commands, task names, box names and built-in documentation.

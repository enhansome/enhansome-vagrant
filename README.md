...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,363 | 🐛 572 | 🌐 Shell | 📅 2026-08-25 - auto-complete for commands, task names, box names and built-in documentation.

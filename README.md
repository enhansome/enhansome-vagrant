...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,369 | 🐛 106 | 📅 2026-09-02 [![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/iJackUA/awesome-vagrant?utm_source=badge\&utm_medium=badge\&utm_campaign=pr-badge) [![Build Status](https://api.travis-ci.org/iJackUA/awesome-vagrant.svg?branch=master)](https://travis-ci.org/iJackUA/awesome-vagrant)

A curated list of awesome Vagrant resources, plugins, tutorials and other nice things.

## Official resources

* [GitHub repo](https://github.com/hashicorp/vagrant) ⭐ 27,208 | 🐛 758 | 🌐 Ruby | 📅 2026-09-21 - source code, issues discussion and collaboration.
...
* [Baseboxes from Opscode](https://github.com/chef/bento#current-baseboxes) ⭐ 4,449 | 🐛 25 | 🌐 HCL | 📅 2026-08-08 - CentOS, Fedora, Debian, FreeBSD, Ubuntu.
...
* [List of available Vagrant plugins from GitHub wiki](https://github.com/hashicorp/vagrant/wiki/Available-Vagrant-Plugins) ⭐ 27,208 | 🐛 758 | 🌐 Ruby | 📅 2026-09-21.
...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,888 | 🐛 296 | 🌐 Shell | 📅 2026-09-23 - auto-complete for commands, task names, box names and built-in documentation.

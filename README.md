...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,775 | 🐛 313 | 🌐 Shell | 📅 2026-09-16 - auto-complete for commands, task names, box names and built-in documentation.

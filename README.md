...
* [Baseboxes from Opscode](https://github.com/chef/bento#current-baseboxes) ⭐ 4,443 | 🐛 21 | 🌐 HCL | 📅 2026-08-08 - CentOS, Fedora, Debian, FreeBSD, Ubuntu.
...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,351 | 🐛 573 | 🌐 Shell | 📅 2026-08-24 - auto-complete for commands, task names, box names and built-in documentation.

...
* [GitHub repo](https://github.com/hashicorp/vagrant) ⭐ 27,195 | 🐛 752 | 🌐 Ruby | 📅 2026-08-03 - source code, issues discussion and collaboration.
...
* [List of available Vagrant plugins from GitHub wiki](https://github.com/hashicorp/vagrant/wiki/Available-Vagrant-Plugins) ⭐ 27,195 | 🐛 752 | 🌐 Ruby | 📅 2026-08-03.
...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,215 | 🐛 593 | 🌐 Shell | 📅 2026-08-16 - auto-complete for commands, task names, box names and built-in documentation.

...
* [Vagrant plugin for ZSH shell](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#vagrant) ⭐ 189,531 | 🐛 575 | 🌐 Shell | 📅 2026-09-01 - auto-complete for commands, task names, box names and built-in documentation.
